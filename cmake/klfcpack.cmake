...
if(KLF_USE_CPACK)
  ...
  macro(ForceValueForCPack var value)
    if(NOT ${var} STREQUAL "${value}")
      KLFNote("For CPack on ${KLF_CMAKE_OS}, ${var} must be set to \"${value}\". Corrected.") 
  ...
  macro(ForceValueForCPackTrue var)
    if(NOT ${var})
      KLFNote("For CPack on ${KLF_CMAKE_OS}, ${var} must be set to TRUE. Corrected.") 
  ...
  macro(ForceValueForCPackFalse var)
    if(${var})
      KLFNote("For CPack on ${KLF_CMAKE_OS}, ${var} must be set to FALSE. Corrected.") 
  ...
  if(WIN32)
    ...
    #  KLFNote("For windows CPack, CMAKE_INSTALL_PREFIX must be set to '/.'. Corrected. Please re-run.")
  ...
  if(KLF_MACOSX_BUNDLES)
    ...
    # if(NOT KLF_INSTALL_BIN_DIR STREQUAL "/." OR NOT CMAKE_INSTALL_PREFIX STREQUAL "/." OR KLF_INSTALL_DEVEL)
    #   set(CMAKE_INSTALL_PREFIX "/." CACHE PATH
    #     "CMake install prefix -- forced value for CPack" FORCE)
    #   set(KLF_INSTALL_BIN_DIR "/." CACHE PATH
    #     "KLF binary install prefix -- forced value for CPack" FORCE)
    #   set(KLF_INSTALL_ OFF CACHE PATH
    #     "Flag to install klf development files/libraries -- forced value for CPack" FORCE)
    #   KLFNote("For windows CPack, CMAKE_INSTALL_PREFIX and KLF_INSTALL_BIN_DIR must be set to '/.', and KLF_INSTALL_DEVEL must be OFF. Corrected. Please re-run.")
    #   message(FATAL_ERROR "Bad CMAKE_INSTALL_PREFIX,KLF_INSTALL_BIN_DIR,KLF_INSTALL_DEVEL detected and corrected. Please re-run.")
    # endif()
  endif()
